...
namespace ACRRentalCar
{
    public partial class frmConsultaCliente : Form
    {
        ...
        public frmCadastroCliente FrmCadastroCliente { get; }
        ...
        private void frmConsultaCliente_Load(object sender, EventArgs e)
        {
            ...
            sqlQuery = "SELECT id_cliente, nome, cpf, data_nasc FROM cliente ORDER BY id_cliente";
        ...
        private void btnSelecionar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dtr.Read())
                {
                    ...
                    FrmCadastroCliente.txtCodigo.Text = dtr["ID_CLIENTE"].ToString();
                    FrmCadastroCliente.txtNome.Text = dtr["NOME"].ToString();
                    FrmCadastroCliente.mskDtNasc.Text = dtr["DATA_NASC"].ToString();
                    FrmCadastroCliente.msk_CPF.Text = dtr["CPF"].ToString();
                }
            }
